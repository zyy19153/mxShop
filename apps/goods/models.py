...
class GoodsCategoryBrand(models.Model):
    '''品牌名'''
    category = models.ForeignKey(GoodsCategory, on_delete=models.CASCADE, null=True, blank=True, related_name="brands" ,verbose_name='商品类目')
...
class Goods(models.Model):
    ...
    goods_desc = UEditorField(verbose_name=u'内容', imagePath='goods/image', width=1000, height=300, filePath='goods/files', default="")
