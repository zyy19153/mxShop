...
class OrderInfo(models.Model):
    ...
    trade_no = models.CharField(max_length=100, null=True, unique=True, blank=True, verbose_name=u"交易号")
...
class OrderGoods(models.Model):
    '''订单商品详情'''
    order = models.ForeignKey(OrderInfo, on_delete=models.CASCADE, related_name="orders", verbose_name="订单消息")
